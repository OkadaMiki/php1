              ...
              <div class="flex-grow mr-0 md:mr-10 mb-5 md:mb-0">
                <div class="mb-5">
                  <div class="flex flex-col w-6/12">
                    ...
                    <p class="bg-white px-2 py-2 border rounded-md outline-none"><?= $product["product_code"] ?></p>
                  </div>
                </div>
                  ...
                  <div class="flex flex-col flex-grow mr-10">
                    ...
                    <select name="category" class="bg-white px-2 py-2 border  rounded-md outline-none focus:border-green-200">
                      <?php foreach ($categories as $category) : ?>
                        <option value="<?= $category->id ?>" <?php if ($productCode["category"] == $category->id) : ?> selected <?php endif ?>>
                          <?= $category->name ?>
                        </option>
                      <?php endforeach ?>
                    </select>
