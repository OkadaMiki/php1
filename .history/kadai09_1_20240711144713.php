        ...
        <div class="product-wrap px-5 py-10 shadow-md">
          ...
          <form action="kadai09_2.php" method="POST">
              ...
              <div class="flex-grow mr-0 md:mr-10 mb-5 md:mb-0">
                <div class="mb-5">
                  <div class="flex flex-col w-6/12">
                    ...
                    <p class="bg-white px-2 py-2 border rounded-md outline-none"><?= $result["product_code"] ?></p>
                  </div>
                </div>
                  ...
                  <div class="flex flex-col flex-grow mr-10">
                    ...
                    <select name="category" class="bg-white px-2 py-2 border  rounded-md outline-none focus:border-green-200">
                      <?php foreach ($categories as $category) : ?>
                        <option value="<?= $category->id ?>" <?php if ($result["category"] == $category->id) : ?> selected <?php endif ?>>
                          <?= $category->name ?>
                        </option>
                      <?php endforeach ?>
                    </select>
                ...
                <div class="flex flex-col">
                  ...
                  <input type="text" name="name" id="name" class="px-2 py-2 border rounded-md outline-none focus:border-green-200" value="<?= $result["name"] ?>">
                </div>
              </div>
            ...
            <div class="flex flex-col sm:flex-row justify-end">
              <a href="kadai06_1.php" class="text-white text-center leading-10 bg-gray-600 px-10 mr-0 sm:mr-5 hover:bg-gray-500 rounded-md">戻る</a>
